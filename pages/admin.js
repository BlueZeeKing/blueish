...
function Main(props) {
  ...
  return (
    <div className="text-center absolute transform -translate-x-1/2 -translate-y-1/2 top-[50%] left-[50%] w-[90vw]">
      ...
      <button className="m-4 font-bold text-xl md:text-2xl bg-gray-300 bg-opacity-0 focus:bg-opacity-100 text-gray-300 focus:text-black border-gray-500 focus:border-gray-300 hover:border-white border-2 outline-none focus:outline-none p-6 transition-all duration-500 w-60" onClick={clickHandler}>Start</button>
      <button className="m-4 font-bold text-xl md:text-2xl bg-gray-300 bg-opacity-0 focus:bg-opacity-100 text-gray-300 focus:text-black border-gray-500 focus:border-gray-300 hover:border-white border-2 outline-none focus:outline-none p-6 transition-all duration-500 w-60" onClick={clickHandler}>Randomize</button>
    </div>
  )
}
